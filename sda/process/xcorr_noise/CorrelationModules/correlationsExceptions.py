...
class ErrorParamFromParamFile(ErrorParam):
    ...
    def __str__(self):
        ...
        if self.NameArgument == 'ListOfDates':
            self.__Message = "There is no list of dates named \'ListOfDates\' define in the module "
        ...
        if self.NameArgument == 'LenTrace':
            self.__Message = "There is no integer named \'LenTrace\' stricly greater than 0 in the module"
        if self.NameArgument == 'NumberSubLen':
            self.__Message = "There is no integer named \'NumberSubLen\' stricly greater than 0 in the module"
        if self.NameArgument == 'GoodNumber':
            self.__Message = "There is no integer named \'GoodNumber\' stricly greater than parameter \'LenTrace\' in the module"
        if self.NameArgument == 'Maxlag':
            self.__Message = "There is no integer named \'Maxlag\' stricly greater than 0 in the module"
        ...
        if self.NameArgument == 'FormatSave':
            self.__Message = "There is no string named \'FormatSave\' in the module"
