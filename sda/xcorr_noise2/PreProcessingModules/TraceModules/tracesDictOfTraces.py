    ...
    def writeDirectory(self, pathDir):
        ...
        try:
            ...
            try:
                ...
                # print("[WARNING] Directory " + pathDir + " cannot be created. Perhaps it already exists, files in will be overwritten.")
                pass
        ...
        for row in cursor.fetchall():
            try:
                ...
                DictInfosFile = {
                    ...
                    "indexTrace": row_dict["INDEXTRACE"],
                    "channel": row_dict["CHANNEL"],
                    "sampling_rate": row_dict["SAMPLING_RATE"],
                    "delta": row_dict["DELTA"],
                    "starttime": obspy.core.UTCDateTime(row_dict["STARTTIME"]),
                    "endtime": obspy.core.UTCDateTime(row_dict["ENDTIME"]),
                    "npts": row_dict["NPTS"],
                ...
                starttime = DictInfosFile["starttime"].datetime
                endtime = DictInfosFile["endtime"].datetime
                ...
                Channel = row_dict["CHANNEL"]
                Component = Channel[-1]
                # FreqSamplingRate = float(numpy.round(float(row_dict["SAMPLING_RATE"])*1000)/1000)
                # DateTime = DictInfosFile["starttime"]
